...
func init() {
	...
	if err != nil {
		fmt.Println("❌ ไม่สามารถรันโปรแกรมได้ กรุณาติดต่อทีมงาน1")
		os.Exit(1)
	}
	...
	if err != nil {
		fmt.Println("❌ ไม่สามารถรันโปรแกรมได้ กรุณาติดต่อทีมงาน2")
		os.Exit(1)
	}
	...
	if os.Getenv("ENV") != "dev" {
		if !checker.Check() {
			fmt.Println("❌ ไม่สามารถรันโปรแกรมได้ กรุณาติดต่อทีมงาน3")
			os.Exit(1)
		}
	}
...
func main() {
	...
	utils.ShowBanner(
		...
		color.RGB(102, 178, 255).Sprintf("© 2025 Nevilsoft Ltd., Part."),
		"",
